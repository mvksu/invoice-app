...
const Navbar: FC = () => {
  return (
    <nav className="bg-dark-300 dark:bg-dark-200 h-24 w-full md:w-24 md:min-h-screen sticky md:top-0 rounded-none md:rounded-t-3xl flex md:flex-col justify-between z-50 transition-all duration-300 top-0">
      <Link
        to="/"
